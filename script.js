...
// --- TEMALAR GÜNCELLENDİ: Senin Yüklediğin GIF'ler Eklendi ---
const THEMES = {
  // Statik Resimler
  ...
  // Senin Yüklediğin Hareketli GIF'ler (Hızlıresim Linkleri)
  retro_sunset:    "url('https://i.hizliresim.com/k92v17v.gif')",
  anime_sky:       "url('https://i.hizliresim.com/jbokbfl.gif')",
  chill_day:       "url('https://i.hizliresim.com/8p2uzxp.gif')",
  pixel_adventure: "url('https://i.hizliresim.com/de1r59p.gif')",
  study_mode:      "url('https://i.hizliresim.com/pkkws1z.gif')"
};
...
function onFinish(){
  ...
  // Sadece Pomodoro bittiğinde günlük sayacı artırma
